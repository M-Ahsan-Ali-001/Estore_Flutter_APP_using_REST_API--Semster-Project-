...
import 'package:share_test/shop_reset.dart';
class Shop_mailerr extends StatefulWidget {
  const Shop_mailerr({Key? key}) : super(key: key);

  @override
  _Shop_mailerrState createState() => _Shop_mailerrState();
}

class _Shop_mailerrState extends State<Shop_mailerr> {
  String username = 'estore101pk@gmail.com';
  String password = 'FLUTTER_project1';
  int  OTP=0;
  String sid='service_cjjg1pd';
  String tid='template_vczyekm';
  String uid='bcPbkc51YFNcSYx1p';
  String rpo=" ";
  ...
  Future email()async{
    print("asdad");
    final chk= await http.post(Uri.parse("http://10.4.30.54/flutter_mysql_server/sp_ck.php"),
        body: {
  ...
  void chkk()
  {
    ...
    if (x==OTP.toString()){
      ...
      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>
          sh_reset(name:_name.text ,email:_eml.text.toString() ,)), (route) => false);
    }
    else
    {
      setState(() {
